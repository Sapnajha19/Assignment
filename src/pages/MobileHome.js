...
import MobileAddProfileForm from '../components/MobileAddProfileForm'
...
export default function MobileHome() {
    ...
    return (
        <div>
            {isDashboardMenuOpen ? (
                <div className='relative right-1 ml-auto z-10 '>
                <button
                    className='fixed bg-white text-blue-500 font-bold py-2 px-4 rounded'
            ...
            {isDashboardMenuOpen && <div style={isDashboardMenuOpen ? { 
          position: "fixed",
          overflow: "hidden",
          top: 0,
          left: 0,
          zIndex: 1,
         } : { position: "absolute" }} className='w-[20rem] h-screen fixed absolute top-0 left-[0px] bg-gradient-to-b from-blue-500 to-blue-500 rounded-r-[20px] flex flex-col z-1'>
    ...
    <div className='w-full h-full bg-[#F8FAFF] flex flex-col gap-[12px]'>
        <div className='flex flex-col'>
            ...
            <div className='flex flex-wrap gap-[17px] mt-[40px]'>
            ...
            <div className="w-full h-[359px] items-center mt-[40px]">
                <div className="bg-white rounded-[20px] shadow border-2 border-neutral-200">
            ...
            <div className='flex flex-col md:flex-wrap gap-[40px] mt-[40px]'>
                <div className="sm:w-full md:w-[100px] h-64 items-center">
                    <div className="sm:w-full md:w-[400px] h-64 bg-white rounded-[20px] shadow border-2 border-neutral-200">
                ...
                {isProfileFormSubmitted ? (<div className="sm:w-full md:w-[400px] h-64 bg-white rounded-[20px] shadow border-2 border-neutral-200 flex flex-col">
                ...
                </div>) : (<div className="sm:w-full md:w-[400px] h-64 bg-white rounded-[20px] shadow border-2 border-neutral-200 flex items-center">
            ...
            {isAddProfileFormOpen && (
                <div className="modal relative mr-[500px]">
                    <MobileAddProfileForm close={handleClose} submit={handleSubmit} finalName={setName} finalEmail={setEmail} finalPhone={setPhone} finalYt={setYoutube} finalInsta={setInstagram} />
                </div>
            )}
        </div>
    </div>
