...
export default function MobileAddProfileForm({ close, submit, finalName, finalEmail, finalPhone, finalInsta, finalYt }) {
  ...
  return (
    <div style={{
      ...
      {isNextButtonClicked && !isBackButtonClicked ?
        (
          <div className="w-full left-[0] md:w-[544px] h-[463px] absolute md:left-[20%] top-[10%] md:top-[235.5px] left-[448px] bg-white rounded-2xl shadow flex-col justify-start items-start inline-flex">
            ...
            <div className="self-stretch h-[312px] p-6 flex-col justify-start items-start gap-6 flex">
              <div className="w-[480px] h-10 relative">
                ...
                <div className="left-[250.29px] top-[1.14px] absolute text-[#231F20] text-[16px] font-semibold font-Figtree leading-normal">Social</div>
                <div className="w-[40%] h-1 left-[-0.25px] top-[37.14px] absolute bg-zinc-300 rounded-[30px]" />
                <div className="w-[40%] h-1 left-[200.58px] top-[37.14px] absolute bg-blue-500 rounded-[30px]" />
              </div>
        ...
        ) : (<div className="w-full top-[10vh] left-[0%] md:w-[565px] h-[553px] top-[150px] md:left-[15%] top-[20%] relative bg-white rounded-2xl shadow">
          <div className="w-full md:w-[565px] h-16 pt-4 left-0 top-0 absolute flex-col justify-between items-center inline-flex">
            <div className="self-stretch px-6 justify-between items-center inline-flex">
              <div className='flex flex-row items-center'>
                <div className="w-[252px] self-stretch text-[#231F20] text-[20px] font-semibold font-Figtree leading-loose">Add New Profile</div>
                <button onClick={close}><img src={Cross} alt="cross" className='w-[24px] h-[24px]' /></button>
          ...
          <div className="w-full md:w-[544px] h-[376px] p-6 left-0 top-[63px] absolute flex-col justify-start items-start gap-[2%] inline-flex">
            <div className="w-full md:w-[480px] h-10 relative">
              <div className="h-1 left-[0px] top-[-0.38px] absolute" />
              <div className="left-[86.96px] top-[1.14px] absolute text-[#231F20] text-[16px] font-semibold font-Figtree leading-normal">Basic</div>
              <div className="left-[250.29px] md:left-[360px] top-[1.14px] absolute text-[#231F20] text-[16px] font-semibold font-Figtree leading-normal">Contact</div>
              <div className="w-[50%] h-1 left-[-0.25px] top-[37.14px] absolute bg-blue-500 rounded-[30px]" />
              <div className="w-[50%] h-1 left-[200.58px] md:left-[280px] top-[37.14px] absolute bg-zinc-300 rounded-[30px]" />
            </div>
            <div className="flex-col justify-start items-start gap-4 flex mt-[40px]">
              <div className="h-20 flex-col justify-start items-start gap-2 flex">
                <div className="w-[20rem] md:w-[496px] self-stretch text-[#231F20] text-[16px] font-normal font-Figtree leading-normal">Enter  Name*</div>
                <div className="self-stretch h-12 px-4 py-3 bg-white rounded-lg border border-zinc-100 flex-col justify-start items-start flex">
            ...
            <div className="flex-col justify-start items-start gap-4 flex mt-[5px]">
              <div className="h-20 flex-col justify-start items-start gap-2 flex">
                <div className="w-[20rem] md:w-[496px] self-stretch text-[#231F20] text-[16px] font-normal font-Figtree leading-normal">Enter  Email*</div>
                <div className="self-stretch h-12 px-4 py-3 bg-white rounded-lg border border-zinc-100 flex-col justify-start items-start flex">
            ...
            <div className="flex-col justify-start items-start gap-4 flex mt-[5px]">
              <div className="h-20 flex-col justify-start items-start gap-2 flex">
                <div className="w-[20rem] md:w-[496px] self-stretch text-[#231F20] text-[16px] font-normal font-Figtree leading-normal">Enter  Phone*</div>
                <div className="self-stretch h-12 px-4 py-3 bg-white rounded-lg border border-zinc-100 flex-col justify-start items-start flex">
          ...
          <div className="h-[88px] pb-6 left-[4px] top-[465px] absolute flex-col justify-start items-start gap-6 inline-flex">
            <div className="self-stretch w-[50px] h-[0.5px] bg-[#F2F2F2]"></div>
            <div className="self-stretch px-6 justify-between items-center inline-flex">
              <div className="px-4 py-2 rounded-lg justify-center items-center flex">
                <div className="text-center"></div>
              </div>
